  ...
  return (
    <AuthLayout>
      <div className="pt-10 md:pt-20 px-4 flex flex-col gap-5 items-center w-full max-w-[527px] mx-auto">
        ...
        {/* Heading and subtext */}
        <h1 className="text-3xl font-bold text-left w-full max-w-[399px]">Sign in</h1>
        <p className="text-sm text-gray-500 text-left w-full max-w-[399px]">please login to continue to your account</p>
        ...
        <div className="my-6 border-t w-full max-w-[399px] text-center text-sm text-gray-500">or</div>
